            ...
            <div class="card shadow" id="containsTaskList">
               ...
               <div class="card-footer" id="taskAppendBefore">
                  ...
                  <div class="float-left">
                     <button type="submit" class="btn btn-sm btn-danger" id="deleteButton" name="_method" value="DELETE"><i class="fas fa-trash"></i></button>
                  </div>
               </div>
            </div>
         </div>
...
<script>
   $(document).ready(function () {
       $('#deleteButton').on('mouseenter', function () {
           $(this).html('<i class="fas fa-trash"></i> @lang('server.schedule.manage.delete')');
