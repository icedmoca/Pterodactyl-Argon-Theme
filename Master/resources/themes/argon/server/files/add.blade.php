      ...
      <div class="card shadow">
         <div class="card-header border-transparent">
            <div class="input-group">
               <div class="input-group-prepend"><span class="input-group-text"><code class="code-alt">/home/container/</code></span></div>
         ...
         <div class="card-footer">
            <div class="row">
               <div class="col-lg-8">
                  <button class="btn btn-sm btn-success" id="create_file">@lang('server.files.add.create')</button>
